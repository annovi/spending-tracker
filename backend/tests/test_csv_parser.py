...
from app.schemas.csv_import import ColumnMapping
from app.services.csv_parser_v2 import detect_columns, parse_transactions_csv_with_mapping


class TestCSVParser:
    """CSV parsing (column mapping + bank-style debit/credit)."""
    ...
    def test_parse_with_mapping(self, sample_csv_data):
        ...
        transactions, detected_mapping = parse_transactions_csv_with_mapping(sample_csv_data, mapping)
